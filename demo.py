...
max_frame = 2000  # up to the lenth of video
video_path = "examples/gdg.mp4"  # input video
out_dir = "prediction"  # output dir
cfg_path = "i3d_ori.yaml"  # alternative conf
ckpt_path = "checkpoints/model.pth"  # model
...
if __name__ == "__main__":
    ...
    # 将avi转换为MP4
    clip = VideoFileClip("prediction/gdg.avi")
    clip.write_videofile("prediction/gdg.mp4")
